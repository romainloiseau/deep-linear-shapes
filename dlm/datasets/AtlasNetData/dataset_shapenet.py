...
from . import pointcloud_processor as pointcloud_processor
...
class ShapeNet(data.Dataset):
    ...
    def _getitem(self, index):
        ...
        points = points[np.random.choice(points.shape[0], min(8*self.num_sample, points.shape[0]), replace = False)]
